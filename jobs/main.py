...
WEATHER_TOPIC = os.getenv('WindowsError', 'weather_data')
...
def generate_gps_data(device_id, timestamp, vehicle_type):
    return {
        'id': uuid.uuid4(),
        'deviceId': device_id,
        'timestamp': timestamp,
...
def simulate_journey(producer, device_id):
    while True:
        ...
        gps_data = generate_gps_data(device_id, vehicle_data['timestamp'], 'private')
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, 'Vehicle-CodeWithYou-123')
